...
In order for this app to work with the Yelp Fusion API V3, it needs a Node.js proxy as the Yelp API does not support CORS requests. The NodeJS app was written by [Rob Wu](https://robwu.nl/) and can be found on [GitHub](https://github.com/Rob--W/cors-anywhere). For the purposes of this demo it is hosted on Heroku.
